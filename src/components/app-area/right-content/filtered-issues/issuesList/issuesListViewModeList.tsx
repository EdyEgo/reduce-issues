...
const IssuesListViewModeList: React.FC<IssuesListViewModeListProps> = ({filterMyIssue,filterActiveIssues,filterBackLogIssues,useSearch}) => {
...
//    const viewFilters = useSelector((state:any)=>state.filtersIssues.viewFilters)
    ...
    return (  
        <div className="issues-list-view-mode-list">
             <GroupedIssuesList filterMyIssue={filterMyIssue} useSearch={useSearch}
